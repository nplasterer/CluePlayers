...
public class CR_BoardAdjTargetTests {
	...
	public static void setUp() {
		board = new Board("ClueLayout.csv", "ClueLegend.txt");///I ADDED IN THE FILENAMES (NOT IN ORIGINAL FILE FROM RADER)
	...
	public void testAdjacenciesInsideRooms()
	{
		...
		System.out.println(board.getAdjList(board.calcIndex(4, 0)));
		Assert.assertEquals(0, testList.size());
